...
//       <div className="cookie-banner-banner">
//         <div className="cookie-banner-header">
//           <h1 className="cookie-banner-company-name">
//             {templateData ? templateData.name : "COMPANY"}
//           </h1>
//           <h2 className="cookie-banner-title">
//             {templateData ? templateData.main_text : "Do you agree to let us use cookies?"}
//           </h2>
//         </div>

//         <div className="cookie-banner-content">
//           <p className="cookie-banner-intro">
//             We and <a href="#" className="cookie-banner-link-text">our partners</a> use cookies and trackers to:
//           </p>
...
//           <p className="cookie-banner-details">
//             {templateData ? templateData.info_paragraph : 
//             "Some cookies are needed for technical purposes, while others help with ads, insights, and more."}
//             Learn more in our <a href="#" className="cookie-banner-link-text">privacy center</a>.
//           </p>
