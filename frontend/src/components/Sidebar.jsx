...
import { FiUsers, FiSettings, FiLogOut, FiBarChart2, FiFileText, FiHeadphones } from "react-icons/fi";
    ...
    <div className={`sidebar-component ${isCollapsed ? "collapsed" : ""}`}>
      <Sidebar collapsed={isCollapsed}>
        <div className="logo-container">
          {!isCollapsed && <h2 className="logo-text">Dashboard</h2>}
        </div>
        <Menu>
          ...
          <MenuItem icon={<FiLogOut />} onClick={handleLogout} className="logout-item">Logout</MenuItem>
        </Menu>
      </Sidebar>
